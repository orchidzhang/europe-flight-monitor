...
class SecretFlyingSource(FlightSource):
    ...
    COUNTRY_PATTERNS = {
        ...
        "Denmark": ["Denmark", "Copenhagen", "CPH", "丹麦", "哥本哈根"],
        ...
        "Norway": ["Norway", "Oslo", "Tromso", "Tromsø", "TOS", "Evenes", "EVE", "Harstad", "Narvik", "挪威", "奥斯陆", "特罗姆瑟", "埃沃内斯"],
    ...
    AIRPORT_CITY_PATTERNS = {
        ...
        "Evenes EVE": ["Evenes", "EVE", "Harstad", "Narvik", "埃沃内斯"],
