...
- `CPH` 哥本哈根、`HEL` 赫尔辛基、`ARN` 斯德哥尔摩或 `TLL` 塔林到 `EVE` Evenes，单程，出发日期在 `2027-02-01` 至 `2027-02-15`，价格 `<= 600 RMB`
...
每次运行还会在 GitHub Actions 的 Summary 页面生成中文运行报告，包含：
